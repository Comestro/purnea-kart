...
class EditTitleField extends Component
{
    ...
    public function toggle()
    {
        ...
        $this->cat_title = $this->cat_title ? $this->cat_title : $this->cat_title;
    }
            ...
            <div class="card border">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        @if ($isEdit)
                            <input wire:model="cat_title" type="text" class="form-control rounded-0" placeholder="Enter category title">
                        ...
                        @else
                            <div class="mx-auto text-center">
                                @if (!empty($cat_title))
                                    ...
                                    <p class="lead text-capitalize font-medium text-dark mb-0">{{ $cat_title }}</p>
                                @else
                                    <div wire:loading wire:target="toggle" class="p-3">
                                        <div class="spinner-border text-muted" role="status"></div>
                                        <p class="mt-2 mb-0">Loading...</p>
