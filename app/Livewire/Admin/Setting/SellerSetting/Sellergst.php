...
class Sellergst extends Component
{
    public $seller;
    public $gst;
    public $isEdit = false;
         ...
         <div class="col-lg-12">
            <div class="card border">
                <div class="card-header py-2 d-flex justify-content-between align-items-center">
                    <h5 class="m-0 fw-normal">Seller Gst</h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        @if ($isEdit)
                            <input wire:model="gst" type="text" class="form-control rounded-0" placeholder="Enter category title">
                        ...
                        @else
                            <div class="mx-auto text-center">
                                @if (!empty($gst))
                                    ...
                                    <p class="lead text-capitalize font-medium text-dark mb-0">{{ $gst }}</p>
                                @else
                                    <div wire:loading wire:target="toggle" class="p-3">
                                        <div class="spinner-border text-muted" role="status"></div>
                                        <p class="mt-2 mb-0">Loading...</p>
                                    ...
                                    <i class="text-muted">{{$seller->gst}}</i></p>
                                @endif
                            </div>
                        @endif
                    </div>
