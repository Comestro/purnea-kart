                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-end">
                                            ...
                                            <h3 class="text-dark mt-1 mb-0">{{ $totalVendor }}</h3>
                                        </div> <!-- end col -->
                                    </div> <!-- end row-->
                                </div> <!-- end card body -->
                                <div class="card-footer py-2 bg-light bg-opacity-50">
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @php
                                            $totalCoupon = App\Models\Coupon::count();
                                        @endphp
                                        <div class="col-6 text-end">
                                            <p class="text-muted mb-0 text-truncate">Total Coupon</p>
                                            <h3 class="text-dark mt-1 mb-0">{{ $totalCoupon }}</h3>
                                        </div> <!-- end col -->
                                    </div> <!-- end row-->
                                </div> <!-- end card body -->
                                <div class="card-footer py-2 bg-light bg-opacity-50">
