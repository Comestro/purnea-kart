                 ...
                 <div class="row">
                      ...
                      <div class="col-lg-9">
                           ...
                           <div class="row">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-2.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-3.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-4.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-5.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-6.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-7.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-8.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-9.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-10.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-11.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
                                ...
                                <div class="col-md-6 col-xl-3">
                                     <div class="card">
                                          <img src="{{ asset('assets_admin/images/product/p-12.png')}}" alt="" class="img-fluid ">
                                          <div class="card-body bg-light-subtle rounded-bottom">
