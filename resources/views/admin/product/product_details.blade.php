                              ...
                              <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                   ...
                                   <div class="carousel-inner" role="listbox">
                                        ...
                                        <div class="carousel-item">
                                             <img src="{{ asset('assets_admin/images/product/p-10.png')}}" alt=""
                                                  class="img-fluid bg-light rounded">
                                        </div>
                                        <div class="carousel-item">
                                             <img src="{{ asset('assets_admin/images/product/p-13.png')}}" alt=""
                                                  class="img-fluid bg-light rounded">
                                        </div>
                                        <div class="carousel-item">
                                             <img src="{{ asset('assets_admin/images/product/p-14.png')}}" alt=""
                                                  class="img-fluid bg-light rounded">
                                        </div>
                                   ...
                                   <div class="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100">
                                        ...
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1"
                                             ...
                                             <img src="{{ asset('assets_admin/images/product/p-10.png')}}"
                                                  class="d-block avatar-xl" alt="swiper-indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2"
                                             ...
                                             <img src="{{ asset('assets_admin/images/product/p-13.png')}}"
                                                  class="d-block avatar-xl" alt="swiper-indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3"
                                             aria-label="Slide 3" class="w-auto h-auto rounded bg-light">
                                             <img src="{{ asset('assets_admin/images/product/p-14.png')}}"
                                                  class="d-block avatar-xl" alt="swiper-indicator-img">
                                        </button>
                                   </div>
                              </div>
                    ...
                    <div class="card">
                         <div class="card-body">
                              ...
                              <div class="row align-items-center g-2 mt-3">
                                   <div class="col-lg-3">
                                        <div class="">
                                             <h5 class="text-dark fw-medium">Colors > <span
                                                       class="text-muted">Dark</span></h5>
                              ...
                              <p class="text-muted">Top in sweatshirt fabric made from a cotton blend with a soft
                                   brushed inside. Relaxed fit with dropped shoulders, long sleeves and ribbing around
                                   the neckline, cuffs and hem. Small metal text applique. <a href="#!"
                                        class="link-primary">Read more</a></p>
