                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <button data-bs-toggle="modal"
                                                    data-bs-target="#editBanner{{ $loop->index }}"
                                                    class="btn btn-soft-primary btn-sm"><iconify-icon
                                                        icon="solar:pen-2-broken"
                                                        class="align-middle fs-18"></iconify-icon></button>

                                                {{-- modal --}}
                                                <div class="modal show" id="editBanner{{ $loop->index }}"
                                                                ...
                                                                <form wire:submit.prevent="edit" method="POST">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <label for="alt"
                                                                                    class="form-label">Alt Text</label>
                                                                                <input type="text"
                                                                                    class="form-control"
                                                                                    id="alt" wire:model="alt"
                                                                                ...
                                                                                <div class="dropzone"
                                                                                    ...
                                                                                    <label for="dropzone-file"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <i
                                                                                                class="bx bx-cloud-upload fs-49 text-primary"></i>
                                    ...
                                    <ul class="pagination justify-content-end mb-0">
                                        <li class="page-item {{ $banners->onFirstPage() ? 'disabled' : '' }}">
                                            <a class="page-link" wire:click="previousPage"
                                                wire:loading.attr="disabled" tabindex="-1">Previous</a>
                                        </li>
