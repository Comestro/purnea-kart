                    ...
                    <div class="row g-3">
                         <div class="col-lg-2 text-lg-center">
                              <div class="bg-body d-flex align-items-center justify-content-center rounded py-4">
                                   <img src="{{ asset('assets_admin/images/seller/zara.svg')}}" alt="" class="avatar-xxl flex-shrink-0">
                              </div>
                              <div class="mt-3">
                                  @if($isAprroved)
                         ...
                         <div class="col-lg-3 border-end">
                              <div class="">
                                   <h4 class="mb-1">{{$sellerid->name}}</h4>
