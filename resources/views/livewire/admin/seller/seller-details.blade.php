        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-2 text-lg-center">
                            <div class="bg-body d-flex align-items-center justify-content-center rounded py-4">
                                <img src="{{ asset('assets_admin/images/seller/zara.svg') }}" alt=""
                            ...
                            <div class="">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <p class="mb-0 fs-15">{{ $seller->email }}</p>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <p class="mb-0 fs-15">{{ $seller->mobile }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="ps-lg-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                    ...
                                    <div>
                                        <p class="mb-0 fs-15 fw-medium text-dark">$123k <span
                                                class="ms-1"><iconify-icon icon="solar:course-up-outline"
                                                    class="text-success"></iconify-icon></span></p>
                                    </div>
                                </div>
                                <div class="progress progress-soft progress-md">
                                    <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated"
                                        role="progressbar" style="width: 70%" aria-valuenow="" aria-valuemin="0"
                                        aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                    <p class="mb-0 fs-15 fw-medium text-dark">Woman's Wares</p>
                                    <div>
                                        <p class="mb-0 fs-15 fw-medium text-dark">$233k <span
                                                class="ms-1"><iconify-icon icon="solar:course-up-outline"
                                                    class="text-success"></iconify-icon></span></p>
                                    </div>
                                </div>
                                <div class="progress progress-soft progress-md">
                                    <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                                        role="progressbar" style="width: 90%" aria-valuenow="" aria-valuemin="0"
                                        aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                    <p class="mb-0 fs-15 fw-medium text-dark">Kid's Wares</p>
                                    <div>
                                        <p class="mb-0 fs-15 fw-medium text-dark">$110k <span
                                                class="ms-1"><iconify-icon icon="solar:course-up-outline"
                                                    class="text-success"></iconify-icon></span></p>
                                    </div>
                                </div>
                                <div class="progress progress-soft progress-md">
                                    <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated"
                                        role="progressbar" style="width: 60%" aria-valuenow="" aria-valuemin="0"
                                        aria-valuemax="100"></div>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                    <p class="mb-0 fs-15 fw-medium text-dark">Foot Wares</p>
                                    <div>
                                        <p class="mb-0 fs-15 fw-medium text-dark">$51k <span
                                                class="ms-1"><iconify-icon icon="solar:course-down-outline"
                                                    class="text-danger"></iconify-icon></span></p>
                                    </div>
                                </div>
                                <div class="progress progress-soft progress-md">
                                    <div class="progress-bar bg-info progress-bar-striped progress-bar-animated"
                                        role="progressbar" style="width: 40%" aria-valuenow="" aria-valuemin="0"
                                        aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <p>At ZARA, we believe that fashion is more than just clothing—it's an expression of individuality
                        and a celebration of diversity. Founded in 2003, our journey began with a simple yet powerful
                        vision: to create high-quality, stylish, and comfortable apparel that resonates with people from
                        all walks of life.</p>

                    <h4 class="card-title my-2">Our Mission :</h4>
                    <p>Our mission is to redefine fashion by merging timeless elegance with contemporary design. We
                        strive to offer clothing that not only looks good but also feels good, making everyday wear an
                        enjoyable experience. At the heart of our brand is a commitment to quality, sustainability, and
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            <h3 class="d-flex align-items-center gap-2">$5,563.786 <span
                                    class="badge text-success bg-success-subtle px-2 py-1 fs-12"><i
                                        class="bx bx-up-arrow-alt"></i>4.53%</span></h3>
                            <p class="mb-0 text-muted">Gained <span class="text-success">$378.56</span> This Month !
                            </p>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="my-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="progress flex-grow-1" role="progressbar" aria-label="Basic example"
                        ...
                        <table class="table align-middle mb-0 table-hover table-centered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td> Fashion</td>
                                    <td>08/05/2023</td>
                                    <td> <span class="badge p-1 bg-success-subtle text-success fs-12 me-1"><i
                                                class="bx bx-check-double align-text-top fs-14 me-1"></i>
                                            Published</span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets_admin/images/product/p-2.png') }}"
                                                    alt="" class="avatar-md">
                                            </div>
                                            <div>
                                    ...
                                    <td> <span class="badge p-1 bg-light text-dark fs-12 me-1"><i
                                                class="bx bxs-circle align-middle fs-10 me-1"></i> Pending</span></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-check">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets_admin/images/product/p-3.png') }}"
                                                    alt="" class="avatar-md">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets_admin/images/product/p-4.png') }}"
                                                    alt="" class="avatar-md">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets_admin/images/product/p-5.png') }}"
                                                    alt="" class="avatar-md">
                                            </div>
                                            <div>
                                    ...
                                    <td> Fashion</td>
                                    <td>23/05/2023</td>
                                    <td> <span class="badge p-1 bg-danger-subtle text-danger fs-12 me-1"><i
                                                class="bx bx-time-five align-text-top fs-14 me-1"></i> Draft</span>
                                    </td>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="avatar-md bg-light bg-opacity-50 rounded mx-auto my-3">
                                    <iconify-icon icon="solar:cart-4-broken"
                                        class="fs-32 text-primary avatar-title"></iconify-icon>
                                </div>
                        ...
                        <div class="card-footer border-top">
                            <a href="#!" class="link-dark fw-medium">View More <i
