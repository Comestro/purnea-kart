            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="product-name" wire:model="slug" disabled class="form-control" style="background-color: rgb(214, 214, 214)"
                                placeholder="Items Name">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select class="form-control" id="product-categories" wire:model='category_id' name="category_id">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-light-subtle" wire:model='description' id="description" rows="7"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="number" id="product-quantity" wire:model='quantity' class="form-control"
                ...
                <div class="row">
                    <div class="col-lg-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" id="product-price" wire:model='price' class="form-control" placeholder="000">
                            </div>
                    </div>
                    <div class="col-lg-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" id="product-discount" class="form-control" wire:model='discount_price' placeholder="000">
                            </div>
