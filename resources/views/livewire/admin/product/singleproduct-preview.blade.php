<div>
    <div class="card">
        <div class="card-body">
             <img src="{{ asset('assets_admin/images/product/p-1.png')}}" alt="" class="img-fluid rounded bg-light">
             <div class="mt-3">
                  <h4>{{$products->name}} <span class="fs-14 text-muted ms-1">({{$products->category->cat_title}})</span></h4>
                  <h5 class="text-dark fw-medium mt-3">Price :</h5>
                  <h4 class="fw-semibold text-dark mt-2 d-flex align-items-center gap-2">
                       <span class="text-muted text-decoration-line-through">${{$products->price}}</span> ${{$products->discount_price}} <small class="text-muted"> (30% Off)</small>
                  </h4>
                  <div class="mt-3">
