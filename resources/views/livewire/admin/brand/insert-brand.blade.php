                ...
                <form wire:submit.prevent="store"> <!-- Prevent default form submission -->
                    <div class="mb-4 row g-3">
                        <div class="col-xl-6">
                            ...
                            <input type="text" wire:model.live="brand_name" placeholder="Enter your Brand name" class="form-control" />
                            @error('brand_name')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea rows="6" placeholder="Type your message" class="form-control" wire:model.live="brand_description"></textarea>
