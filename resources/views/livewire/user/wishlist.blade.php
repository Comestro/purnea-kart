<div class="bg-white p-6 rounded-lg shadow-lg">
    <div class="w-full">
        ...
        @forelse ($grouplistwishlist as $category => $wishlistItems)
            <div class="mb-4">
                <h3 class="text-xl font-bold text-gray-700 mb-2">{{ $category }}</h3>
                        ...
                        <div class="w-full flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center gap-4 mb-2">
                                    ...
                                    <span class="text-green-600 font-medium">{{ $wish->product->saving_percentage }}%
                                        off</span>
                                </div>
                            </div>
                        </div>
