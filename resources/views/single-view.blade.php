...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-[70px] ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <!-- Product Image -->
            <div class="px-5">
                <img src="{{ asset('storage/public/image/product/' . $product->images->first()->path) }}" alt="Product Image"
            ...
            <div class="bg-white px-5 rounded-lg ">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex space-x-4 mt-2">
                        ...
                        <button class="px-4 py-2 bg-gray-100 text-gray-800 rounded-md border border-gray-300">{{ $item->variant_name }}</button>
