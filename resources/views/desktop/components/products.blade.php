    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <div class="max-w-xs bg-white p-2 rounded-lg shadow-lg">
            ...
            <div class="mt-2 flex items-center justify-center">
                <span class="text-2xl font-semibold text-gray-800">₹15,999</span>
                <span class="text-xs text-gray-600 ml-2">M.R.P: <del>₹24,999.00</del></span>
            </div>

            <p class="text-sm font-medium text-gray-700 mt-2 line-clamp-2">POCO X6 5G (Mirror Black, 8 GB RAM)</p>
        </div>
        {{-- card --}}
        <div class="max-w-xs bg-white p-2 rounded-lg shadow-lg">
            <img class="w-full h-36 object-cover rounded-md" src="https://via.placeholder.com/200x300"
