...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('assets_vendor/images/favicon.png') }}">
    ...
    <!-- Bootstrap Docs -->
    <link rel="stylesheet" href="{{ asset('assets_vendor/css/bootstrap-docs.css') }}" type="text/css">

    <!-- Slick -->
    <link rel="stylesheet" href="{{ asset('assets_vendor/libs/slick/slick.css') }}" type="text/css">
...
<body>
   ...
   @include('vendor.include.sidebar')
    ...
    <!-- Apex chart -->
    <script src="{{ asset('assets_vendor/libs/charts/apex/apexcharts.min.js') }}"></script>

    <!-- Slick -->
    <script src="{{ asset('assets_vendor/libs/slick/slick.min.js') }}"></script>

    <!-- Examples -->
    <script src="{{ asset('assets_vendor/js/examples/dashboard.js') }}"></script>

    <!-- Main Javascript file -->
    <script src="{{ asset('assets_vendor/js/app.min.js') }}"></script>
    <script src="{{ asset('assets_vendor/libs/ckeditor5/ckeditor.js')}}"></script>
    <script>
