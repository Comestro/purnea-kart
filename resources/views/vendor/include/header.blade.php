...
<div class="header">
    ...
    <a href="index.html" class="logo">
        <img width="100" src="{{ asset('assets_vendor/images/logo.svg') }}" alt="logo">
    </a>
    <!-- ./ Logo -->
    ...
    <div class="header-bar ms-auto">
        <ul class="navbar-nav justify-content-end">
                    ...
                    <div class="dropdown-menu-body">
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('assets_vendor/images/products/3.jpg') }}"
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('assets_vendor/images/products/4.jpg') }}"
                                        class="rounded" width="60" alt="...">
                                </a>
                                <div>
                                    <h6>Toy Car</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('assets_vendor/images/products/5.jpg') }}"
                                        class="rounded" width="60" alt="...">
                                </a>
                                <div>
                                    <h6>Sunglasses</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('assets_vendor/images/products/6.jpg') }}"
                                        class="rounded" width="60" alt="...">
                                </a>
                                <div>
                                    <h6>Cake</h6>
            ...
            <li class="nav-item ms-3">
                ...
                <a class="btn btn-primary btn-icon" href="{{url('/vendor/addproduct')}}"> <i class="bi bi-plus-circle"></i> Add Product</a>
