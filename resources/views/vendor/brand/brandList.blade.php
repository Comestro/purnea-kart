                    ...
                    <table class="table table-custom table-lg mb-0" id="brands">
                            ...
                            <tr>
                                <th>
                                    <input class="form-check-input select-all" type="checkbox"
                                        data-select-all-target="#brands" id="defaultCheck1">
                                </th>
                                <th>ID</th>
                                <th>logo</th>
                                <th>Brand name</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/1.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Headphone</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/2.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Shoe</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/3.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Digital clock</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/4.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Toy car</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/5.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Sunglasses</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/6.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Cake</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/7.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Glass</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/8.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Headphone</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/9.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Perfume</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ asset('assets_vendor/images/brands/10.jpg') }}" class="rounded"
                                            width="40" alt="...">
                                    </a>
                                </td>
                                <td>Cookie</td>
