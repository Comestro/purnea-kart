                ...
                <div class="table-responsive">
                    <table class="table table-custom table-lg mb-0" id="products">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/2.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Shoe</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/3.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Digital clock</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/4.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Toy car</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/5.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Sunglasses</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/6.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Cake</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/7.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Glass</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/8.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Headphone</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/9.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Perfume</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{ asset('assets_vendor/images/products/10.jpg')}}" class="rounded" width="40" alt="...">
                                </a>
                            </td>
                            <td>Cookie</td>
                            <td>
